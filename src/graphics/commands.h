...
struct IndexedDrawCall {
    ...
    IndexedDrawCall(IndexBufferBinding indexBuffer)
        : indexBuffer(indexBuffer) {}

    IndexedDrawCall(IndexBufferBinding indexBuffer, GLuint firstVertex)
            : indexBuffer(indexBuffer), firstVertex(firstVertex) {}
};
